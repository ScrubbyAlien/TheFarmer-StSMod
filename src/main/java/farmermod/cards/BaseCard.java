package farmermod.cards;

import basemod.abstracts.CustomCard;
import farmermod.FarmerMod;
...
import static farmermod.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    FarmerMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
