...
import static farmermod.FarmerMod.characterPath;
import static farmermod.FarmerMod.makeID;

public class TheFarmer extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Farmer"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_FARMER;
        @SpireEnum(name = "FARMER_GREEN_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "FARMER_GREEN_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public TheFarmer() {
        super(NAMES[0], Enums.THE_FARMER,
